...
public class DriveCommands {
  ...
  /* 
  public static Command autoAlignCommand(Vision vision, Drive drive, DoubleSupplier xSupplier, DoubleSupplier ySupplier, Supplier<Rotation2d> rotationSupplier){
    double tx = LimelightHelpers.getTX("limelight");
    if (tx < 0){
      return Commands.run(() -> joystickDriveAtAngle(drive, xSupplier, ySupplier, Rotation2d.fromDegrees(1)));
    }
    if (tx > 0){
      return Commands.run(() -> joystickDriveAtAngle(drive, xSupplier, ySupplier, Rotation2d.fromDegrees(1)));
    }
